...
print()
input_n = int(input("Please enter a positive integer:"))
sum_of_loops = 0
while input_n != 1:  # until n is equal to 1 , run the nested if statements
    if (input_n % 2) == 0:  # if n can be modded by 2, then that number is even
        ...
        sum_of_loops += 1  # add an iteration to the sum of loops
        ...
        sum_of_loops += 1  # adding an iteration to the sum of total loops
print(input_n)  # when n does = 1
print("This process took", sum_of_loops, "iterations to complete.")  # printing how many iterations this process took
