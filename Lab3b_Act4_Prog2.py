...
# observers position
print("Please input the values you wish the observer to be positioned at in terms of line_number,y and z respectably:")
# Getting all user inputs
x0 = float(input('X:'))
y0 = float(input('Y:'))
z0 = float(input('Z:'))
# observation of placement one inputs
print("Please input the values you wish the first given to be positioned at line_number,y and z respectably:")
x1 = float(input('X:'))
y1 = float(input('Y:'))
z1 = float(input('Z:'))
# observation of placement numpy_annual_cost inputs
print("Please input the values you wish the second given to be positioned at line_number,y and z respectably:")
x2 = float(input('X:'))
y2 = float(input('Y:'))
z2 = float(input('Z:'))
print("Observer location is: line_number=", x0, "y=", y0, "z=", z0)
print("Point 1 location is: line_number=", x1, "y=", y1, "z=", z1)
print("Point 2 location is: line_number=", x2, "y=", y2, "z=", z2)
# formula to find both vector one and vector numpy_annual_cost from the observers location
# (range_1-x0, y1-y0,z1-z0)
vector_one_x1 = (x1 - x0)
vector_one_y1 = (y1 - y0)
vector_one_z1 = (z1 - z0)
...
# the list_of_evaluated_areas for normalizing the vectors can be represented as such:
